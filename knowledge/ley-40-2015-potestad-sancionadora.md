...
**Cómo se ha obtenido el texto.** Transcripción literal de la versión consolidada vigente,
descargada con `scripts/boe_fetch.py` (API de datos abiertos del BOE) el 2026-09-23.
...
(20260923T065942Z) es la fecha del registro, no la del texto. Metadatos a 2026-09-23:
`estatus_derogacion: N`, `estatus_anulacion: N`, `vigencia_agotada: N`.

**Por qué está aquí.** El art. 112 del RDL 6/2015 (tráfico) regula plazos de prescripción
de infracciones y sanciones, su interrupción y su día inicial, pero no todos los supuestos.
El capítulo III del título preliminar de esta Ley recoge los principios de la potestad
...
| Responsabilidad | 28.1 | «a título de dolo o culpa» | Titular vs. conductor (RDL 82) |
| Proporcionalidad | 29 | Criterios de graduación 29.3 a)-d) | RDL 81 tiene reglas propias |
| Prescripción: remisión | 30.1 | «prescribirán según lo dispuesto en las leyes que las establezcan» | En tráfico, los plazos los fija el RDL 112 |
| Prescripción: infracciones continuadas o permanentes | 30.2 | «el plazo comenzará a correr desde que finalizó la conducta infractora» | El RDL 112.1 no lo regula |
| Prescripción de sanciones: día inicial | 30.3, párr. 1 | «desde el día siguiente a aquel en que sea ejecutable la resolución […] o haya transcurrido el plazo para recurrirla» | El RDL 112.4 cuenta desde la firmeza en vía administrativa |
| Prescripción de sanciones: alzada no resuelta | 30.3, párr. 3 | «desde el día siguiente a aquel en que finalice el plazo legalmente previsto para la resolución de dicho recurso» | En tráfico cabe reposición (RDL 96.2), no alzada: ver dudas |
| Non bis in idem | 31.1 | «identidad del sujeto, hecho y fundamento» | Concurrencia penal: RDL 85 |
...
<!-- bloque a26 · versión publicada 20151002 · vigente desde 20161002 -->
...
<!-- bloque a27 · versión publicada 20151002 · vigente desde 20161002 -->
...
<!-- bloque a28 · versión publicada 20151002 · vigente desde 20161002 -->
...
2. `TODO(juridico)`: Relación entre el día inicial del art. 112.4 RDL 6/2015 («desde el
   ...
   para recurrirla»), teniendo en cuenta que el art. 96.1 RDL hace ejecutable la sanción
   desde el día siguiente a su notificación. Fuente: jurisprudencia del TS (CENDOJ).
3. `TODO(juridico)`: ¿Qué infracciones de tráfico pueden ser continuadas o permanentes
   a efectos del art. 30.2 (p. ej. estacionamiento prolongado, falta de seguro, ITV
   caducada)? Fuente: jurisprudencia del TS/TSJ (CENDOJ).
